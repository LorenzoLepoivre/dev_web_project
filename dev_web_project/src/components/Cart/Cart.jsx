        ...
        <Modal.Body>
          ...
          {cart.map((element) => ( 
            <tr>
              ...
              <td>{element[2]}</td>
              <td>{element[3]}</td>
              <td><Button variant="secondary" onClick={() => deleteItem(element[0])}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
